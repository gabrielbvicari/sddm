...
A modern SDDM theme focused on simplicity and readability. Based on [SilentSDDM](https://github.com/uiriansan/SilentSDDM) by uiriansan, redesigned with a minimal aesthetic:
...
The theme can be customized by editing `theme.conf`. Available options include background image, blur intensity, clock format, and color overrides.
